...
build:
	go build ./...
	go build -o .tmp/acp-go-amp ./cmd/acp-go-amp
...
test-integration-live:
	ACP_GO_AMP_RUN_LIVE_TOKENS=1 ACP_GO_AMP_RUN_INTEGRATION=1 go test -race -count=1 -tags=integration -timeout=900s -v ./integration/...
