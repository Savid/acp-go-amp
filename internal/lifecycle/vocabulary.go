...
//
// It reduces the whole event set, including events a prompt-contained
// configuration never emits, because the same code validates this adapter's own
...
// Valid reports whether the proof class is the sole member of the closed set.
