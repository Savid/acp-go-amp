...
func TestAgentStandaloneProcessIsolationDispositionValidation(t *testing.T) {
	...
	standalone := &ProcessIsolation{
		StandaloneOwnerID: "Amp.Deployment-1", StandaloneStateRoot: "/srv/amp/state",
	}
	...
	invalid := []*ProcessIsolation{
		...
		{StandaloneOwnerID: "-owner", StandaloneStateRoot: "/srv/amp/state"},
		{StandaloneOwnerID: "owner", StandaloneStateRoot: "/var/lib/acp-go/agent-identities/amp"},
	}
...
func TestAgentStandaloneOwnerDigestExactVector(t *testing.T) {
	...
	require.Equal(t, "standalone:bc3d87172a95030fc87f2d819ea001d39cdb603fba4d5c0f9ae3da31931e7415", key)
}
...
func TestAgentStandaloneOwnerCloseFailurePreventsPublication(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/close-fault", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneOwnerTemporaryBusyRetriesUntilCanceled(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/owner-temp-cancel", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneDomainRebindOwnerTemporaryBusyCancelsWithoutUnlink(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/domain-owner-temp", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneRebindProbeFailureLeavesOldDomainRecordIntact(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/probe-failure", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneRebindRejectsOverlayFilesystemBeforeDomainMutation(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/overlay-rebind", Dev: 1, Ino: 2},
	}
...
func TestAgentStandaloneDomainAuditCleansBoundMarkerTemporaryWithoutDispositionMutation(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/bound-marker-temp", Dev: 31, Ino: 32},
	}
...
func TestAgentStandaloneClaimRaceJoinsOwnerCleanupAndToleratesUnrelatedMarkerTemporary(t *testing.T) {
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/claim-race", Dev: 41, Ino: 42},
	}
...
func TestAgentStandaloneSameBootRebindRejectsSecondOwner(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/same-boot", Dev: 11, Ino: 12},
	}
	owners := createAgentStandaloneTestLock(t, directory, "owners.lock", ownerUID, ownerGID)
	require.NoError(t, owners.Close())
	...
	other := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/unrelated-bound", Dev: 13, Ino: 14},
	}
...
func TestAgentStandaloneSameBootRebindRejectsMatchingTask(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/same-boot-live-task", Dev: 21, Ino: 22},
	}
	owners := createAgentStandaloneTestLock(t, directory, "owners.lock", ownerUID, ownerGID)
	require.NoError(t, owners.Close())
...
func TestAgentStandaloneSameBootRebindRetainsUIDLockThroughDomainPublication(t *testing.T) {
	...
	owner := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/same-boot-publish", Dev: 31, Ino: 32},
	}
	owners := createAgentStandaloneTestLock(t, directory, "owners.lock", ownerUID, ownerGID)
	require.NoError(t, owners.Close())
...
func TestAgentStandaloneStateRootRequiresClaimedOwnerModeAndSupportsProtectedRoot(t *testing.T) {
	...
	base, err := os.MkdirTemp("/var/lib", "acp-go-amp-state-root-")
	require.NoError(t, err)
...
func createAgentStandaloneMatchingDomainFixture(
	...
	want := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/amp/matching-domain", Dev: 1, Ino: 2},
	}
